...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1199.7244203114976; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1488.124916983188; // x position of the perpendicular encoder (in tick units)
    }
