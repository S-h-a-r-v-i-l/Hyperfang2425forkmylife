...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1297.3437579125698; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1320.337115254748; // x position of the perpendicular encoder (in tick units)
    }
