...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1626.6041420045772; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1369.300087524421; // x position of the perpendicular encoder (in tick units)
    }
